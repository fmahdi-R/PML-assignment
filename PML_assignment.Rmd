...
After splitting our data into two sets (train and test), we were able to select a good model for predicting the class of activity performed. With an out of sample error rate of `r oose`. 
...
# dev.off()
par(mfrow = c(2,3),mar=c(0,0,2,0),bg = 'lightgrey')
...
Here we plot against "magnet_*" predictors. 

```{r data_exploration plot2, cache=TRUE, warning=FALSE, echo=FALSE,}
# # Check out magnet_*
# # each user 
...
```{r data_exploration plot3, echo=FALSE, eval=FALSE,cache=TRUE, warning=FALSE}
# 
# 
# ### My classe section. 
